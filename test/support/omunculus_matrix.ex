defmodule Omunculus.Matrix do
  ...
  def assert_interceptor_stats!(%{core: core}) do
  ...
  defp run(depth, base, overlay, task) do
    interceptors = resolve_interceptors(base, overlay)
    %{core: core, projector: projector, runtime: runtime} = boot(depth, interceptors)
